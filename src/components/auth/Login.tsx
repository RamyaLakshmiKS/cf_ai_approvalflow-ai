        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center justify-center h-14 w-14 rounded-full bg-[#F48120]/10 text-[#F48120]">
            <svg
              ...
              viewBox="0 0 80 79"
              role="img"
              aria-labelledby="loginLogoTitle"
            >
              <title id="loginLogoTitle">ApprovalFlow logo</title>
              <path
                fill="currentColor"
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold leading-tight text-neutral-900 dark:text-white">
            ApprovalFlow AI
          </h1>
          <p className="text-sm md:text-base text-muted-foreground text-center max-w-prose">
            Get your expenses reimbursed & PTOs approved in seconds
          </p>
        </div>
